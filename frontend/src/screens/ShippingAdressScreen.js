    ...
    return (
        <div>
            ...
            <form className="form" onSubmit={submitHandler}>
                <div>
                    <h1>Shipping Address <i class="fas fa-truck"></i></h1>
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" id="postalCode" placeholder="Enter postal ode" value={postalCode} onChange={(e) => setPostalCode(e.target.value)} required></input>
                </div>
