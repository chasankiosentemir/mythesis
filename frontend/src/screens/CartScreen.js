    ...
    return (
        <div className="row center">
                        ...
                        {cartItems.map((item) => (
                            <li key={item.product}>
                                <div className="row">
                                    ...
                                    <div>
                                        <button className="primary" type="button" onClick={() => removeFromCartHandler(item.product)}>Delete</button>
                                    </div>
                                    </div> 
                            </li>
                        ))
            ...
            <div className="checkout-body card-body">
                <ul>
                    <li>
                        <h2>Items: {cartItems.reduce((a,c)=> a + c.qty, 0)}  </h2>
                        <h2>Price: ${cartItems.reduce((a,c)=> a + c.price * c.qty, 0)}</h2>
                    </li>
                    <li>
